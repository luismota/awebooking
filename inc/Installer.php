...
CREATE TABLE {$wpdb->prefix}awebooking_booking_itemmeta (
  ...
  KEY meta_key (meta_key(32))
	...
	public function create_roles() {
		...
		// Hotel customer: Only manage their profile, view and request some actions their booking.
		add_role( 'awebooking_customer', esc_html__( 'Hotel Customer', 'awebooking' ), [
			'read' => true,
		]);

		// Hotel receptionist: View room types, services, amenities,
		// manage pricing, manage availability, assists guests making hotel reservations.
		...
		// Hotel Manager: Access to all the AweBooking features.
		...
		foreach ( $this->get_core_capabilities() as $cap_group ) {
