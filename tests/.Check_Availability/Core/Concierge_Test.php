...
class Concierge_Test extends WP_UnitTestCase {
	...
	public function testChangeable() {
		...
		$state = new Room_State($rooms[0], new Period('2017-06-12', '2017-06-13'), Constants::STATE_UNAVAILABLE);
		$state->save();

		$state2 = new Room_State($rooms[0], new Period('2017-05-25', '2017-05-26'), Constants::STATE_BOOKED);
		$state2->save();
